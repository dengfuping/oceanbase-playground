  ...
  'node_modules/.pnpm/httpx@2.3.3/node_modules/httpx/lib/index.js'(exports2) {
    ...
    exports2.request = function (url, opts) {
      ...
      if (isNumber(opts.readTimeout) || isNumber(opts.connectTimeout)) {
        readTimeout = isNumber(opts.readTimeout)
          ? Number(opts.readTimeout)
          : TIMEOUT;
        connectTimeout = isNumber(opts.connectTimeout)
          ? Number(opts.connectTimeout)
          : TIMEOUT;
    ...
    exports2.read = function (response, encoding) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const remainTime =
          socket[READ_TIME_OUT] - (Date.now() - socket[READ_TIMER_START_AT]);
        ...
        P.exponentiatedBy = P.pow = function (n, m) {
          ...
          if (
            ...
            y = new BigNumber2(
              Math.pow(
                +valueOf(x),
                nIsBig ? n.s * (2 - isOdd(n)) : +valueOf(n),
              ),
            );
            return m ? y.mod(m) : y;
          }
        ...
        object = function () {
          ...
          if (ch === '{') {
            ...
            while (ch) {
              ...
              if (
                _options.strict === true &&
                Object.hasOwnProperty.call(object2, key)
              ) {
  ...
  'node_modules/.pnpm/@alicloud+pop-core@1.7.13/node_modules/@alicloud/pop-core/package.json'(
    ...
    module2.exports = {
      ...
      scripts: {
        ...
        'test-cov':
          'nyc -r=html -r=text -r=lcov mocha -t 3000 -R spec test/*.test.js',
        'test-integration': 'mocha -R spec test/*.integration.js',
        ci: 'npm run lint && npm run test-cov && codecov',
      },
      keywords: ['Aliyun', 'AliCloud', 'OpenAPI', 'POP', 'SDK', 'Core'],
      author: 'Jackson Tian',
      license: 'MIT',
      dependencies: {
        debug: '^3.1.0',
...
var require_helper = __commonJS({
  'node_modules/.pnpm/@alicloud+pop-core@1.7.13/node_modules/@alicloud/pop-core/lib/helper.js'(
    ...
    exports2.DEFAULT_UA = `AlibabaCloud (${os.platform()}; ${os.arch()}) Node.js/${
      process.version
    } Core/${pkg.version}`;
    ...
    var RPCClient2 = class {
      ...
      async request(action, params = {}, opts = {}) {
        ...
        const url =
          opts.method === 'POST'
            ? `${this.endpoint}/`
            : `${this.endpoint}/?${canonicalize(normalized)}`;
        const entry = {
          url,
          request: null,
          response: null,
        ...
        entry.request = {
          headers: response.req.getHeaders
            ? response.req.getHeaders()
            : response.req._headers,
        };
        entry.response = {
  ...
  'node_modules/.pnpm/xmlbuilder@11.0.1/node_modules/xmlbuilder/lib/XMLDOMImplementation.js'(
    ...
    (function () {
      ...
      module2.exports = XMLDOMImplementation = (function () {
        ...
        XMLDOMImplementation2.prototype.hasFeature = function (
          feature,
          version,
        ) {
          return true;
        ...
        XMLDOMImplementation2.prototype.getFeature = function (
          feature,
          version,
        ) {
          throw new Error('This DOM method is not implemented.');
    ...
    (function () {
      ...
      module2.exports = XMLDOMConfiguration = (function () {
        ...
        Object.defineProperty(
          XMLDOMConfiguration2.prototype,
          'parameterNames',
          {
            get: function () {
        ...
        XMLDOMConfiguration2.prototype.canSetParameter = function (
          name,
          value,
        ) {
          return true;
  ...
  'node_modules/.pnpm/xmlbuilder@11.0.1/node_modules/xmlbuilder/lib/XMLCharacterData.js'(
    ...
    (function () {
      ...
      module2.exports = XMLCharacterData = (function (superClass) {
        ...
        XMLCharacterData2.prototype.replaceData = function (
          offset,
          count,
          arg,
        ) {
      ...
      module2.exports = XMLStreamWriter = (function (superClass) {
        ...
        XMLStreamWriter2.prototype.attribute = function (att, options, level) {
          return this.stream.write(
            XMLStreamWriter2.__super__.attribute.call(
              this,
              att,
              options,
              level,
        ...
        XMLStreamWriter2.prototype.declaration = function (
          node,
          options,
          level,
        ) {
        ...
        XMLStreamWriter2.prototype.dtdAttList = function (
          node,
          options,
          level,
        ) {
        ...
        XMLStreamWriter2.prototype.dtdElement = function (
          node,
          options,
          level,
        ) {
        ...
        XMLStreamWriter2.prototype.dtdEntity = function (node, options, level) {
          return this.stream.write(
            XMLStreamWriter2.__super__.dtdEntity.call(
              this,
              node,
              options,
              level,
        ...
        XMLStreamWriter2.prototype.dtdNotation = function (
          node,
          options,
          level,
        ) {
      ...
      async request(
        ...
        if (contentType.startsWith('application/json')) {
          ...
          if (statusCode >= 400) {
            ...
            var err = new Error(
              `code: ${statusCode}, ${errorMessage}, requestid: ${requestId}`,
            );
...
var apiRoutes = [
  {
    path: 'v1/car_orders/color_top3',
    id: 'v1/car_orders/color_top3',
    file: 'v1/car_orders/color_top3.ts',
    absPath: '/v1/car_orders/color_top3',
    __content:
  ...
  {
    path: 'v1/car_orders/latest',
    id: 'v1/car_orders/latest',
    file: 'v1/car_orders/latest.ts',
    absPath: '/v1/car_orders/latest',
    __content:
      "import type { UmiApiRequest, UmiApiResponse } from 'umi';\nimport { Op } from 'sequelize';\nimport { toNumber } from 'lodash';\nimport model from '../../model';\n\nexport default async function (req: UmiApiRequest, res: UmiApiResponse) {\n  try {\n    let sqlText;\n    let latency;\n    if (req.method === 'GET') {\n      const { orderId } = req.query || {};\n      if (orderId) {\n        const result = await model.OLAPCarOrder.findAll({\n          where: {\n            orderId: {\n              [Op.gt]: toNumber(orderId),\n            },\n          },\n          order: [['orderId', 'DESC']],\n          logging: (sql, timing) => {\n            sqlText = sql?.replaceAll('Executed (default): ', '');\n            latency = timing;\n          },\n        });\n        res.status(200).json({\n          data: result,\n          sqlText,\n          latency,\n        });\n      } else {\n        const result = await model.OLAPCarOrder.findAll({\n          order: [['orderId', 'DESC']],\n          limit: 10,\n          logging: (sql, timing) => {\n            sqlText = sql?.replaceAll('Executed (default): ', '');\n            latency = timing;\n          },\n        });\n        res.status(200).json({\n          data: result,\n          sqlText,\n          latency,\n        });\n      }\n    } else {\n      res.status(405).json({ errorMessage: 'Method not allowed' });\n    }\n  } catch (err) {\n    console.log(err);\n    res.status(500).json({ errorMessage: 'Internal Server Error' });\n  }\n}\n",
  },
  {
    path: 'v1/car_orders/status',
    id: 'v1/car_orders/status',
    file: 'v1/car_orders/status.ts',
    absPath: '/v1/car_orders/status',
    __content:
  ...
  {
    path: 'v1/car_orders/batch',
    id: 'v1/car_orders/batch',
    file: 'v1/car_orders/batch.ts',
    absPath: '/v1/car_orders/batch',
    __content:
  ...
  {
    path: 'v1/car_orders',
    id: 'v1/car_orders/index',
    file: 'v1/car_orders/index.ts',
    absPath: '/v1/car_orders',
    __content:
  ...
  {
    path: 'v1/car_orders/total',
    id: 'v1/car_orders/total',
    file: 'v1/car_orders/total.ts',
    absPath: '/v1/car_orders/total',
    __content:
