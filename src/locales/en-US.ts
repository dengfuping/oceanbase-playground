export default {
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.OceanBaseReadonlyColumnStoreReplica": "Read-only Column Store Replica",
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.ReadonlyColumnStoreReplica": "Read-only Column Store Replica",
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeOrderDashboardReadonlyColumnStoreReplica": "Real-time Order Dashboard (Option 1: Queried from read-only column store replica)",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeOrderDashboardRowStore": "Real-time Order Dashboard (Option 2: Queried from row store replica)",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeExecuteSql": "Real-time SQL Execution",
