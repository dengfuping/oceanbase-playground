export default {
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.OceanBaseHtap": "OceanBase HTAP",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeOrderDashboard": "实时订单看板",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeOrderDashboardReadonlyColumnStoreReplica": "实时订单看板（方案一：从只读列存副本查询）",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeOrderDashboardRowStore": "实时订单看板（方案二：从行存副本查询）",
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealtimeExecuteSql": "实时执行 SQL",
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealTimeOrders": "今日实时订单",
  ...
  "oceanbase-playground.src.pages.OceanBaseWithFlink.RealTimeCarColor": "{color} {count} 辆",
