...
import { Bar, Column, G2 } from '@antv/g2plot';
...
const Chart: React.FC<ChartProps> = ({ data = [], ...restProps }) => {
  ...
  useEffect(() => {
    ...
    const bar = new Column('color-top3-container', {
      data: newData,
      xField: 'carColor',
      yField: 'count',
      padding: [10, 40, 30, 50],
  ...
  useEffect(() => {
    ref.current?.changeData(processData(data, 'carColor'));
  }, [data]);

  return <div id="color-top3-container" style={{ height: 300 }} />;
};
